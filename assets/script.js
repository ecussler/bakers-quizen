...
const Questions = [{
    ...
    a: [{text: `Graham cracker`, isCorrect: true}, 
        ...
        {text: 'Sugar, butter, water', isCorrect: false}, 
        {text: 'Sugar and corn syrup'}
    ]
},
{
    id: 1, 
...
function showQuestion(id) {
    ...
    op1.innerText = questionsArray[id].a[0].text; 
    op2.innerText = questionsArray[id].a[1].text; 
    op3.innerText = questionsArray[id].a[2].text; 
    op4.innerText = questionsArray[id].a[3].text;
    op1.value = questionsArray[id].a[0].isCorrect; 
    op2.value = questionsArray[id].a[1].isCorrect; 
    op3.value = questionsArray[id].a[2].isCorrect; 
    op4.value = questionsArray[id].a[3].isCorrect; 
    }
